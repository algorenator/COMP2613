...
/**
 * Examples of java.lang.Math Methods from <br>
 * http://www.cafeaulait.org/course/week4/40.html
 * <p>
 * Here is an example program that exercises most of the routines in <code>java.lang.Math</code>. If your high school
 * math is a little rusty, don't worry if you don't remember the exact meaning of logarithms or cosines. Just know that
 * they're here in Java if you need them.
 * </p>
 */
...
public class MathLibraryExample {
	...
	public static void main(String[] args) {
		...
		for (int ii = 0; ii < 10; ii++) {
			System.out.println((ii + 1) + ". " + ((int) (Math.random() * 25)));
		}
