...
public class ShowOverlayLayout extends JApplet {
	...
	private final JTextField jtfButton1AlignmentX = new JTextField(4);
	private final JTextField jtfButton1AlignmentY = new JTextField(4);
	private final JTextField jtfButton2AlignmentX = new JTextField(4);
	private final JTextField jtfButton2AlignmentY = new JTextField(4);
	private final JComboBox jcboButton1Opaque = new JComboBox(new Object[] { new Boolean(true), new Boolean(false) });
